#!/usr/bin/env python3
"""
Test the hybrid (semantic + keyword) RAG pipeline
"""
import pickle
import os
import torch
...
if "who is" in question_lower or "name of" in question_lower:
...
print("\n" + "="*80)
print("Top 5 Boosted Chunks (before reranking):")
print("="*80)

for i, doc in enumerate(boosted_docs[:5]):
    print(f"\n--- Boosted Chunk {i+1} ---")
    print(doc.page_content[:300] + "...")
    if "crutch" in doc.page_content.lower():
        print("✓✓✓ HAS CRUTCH!")
...
if "crutch" in context.lower():
    ...
    if "bore a little crutch" in context.lower():
        print("✓✓✓ PERFECT! The exact 'bore a little crutch' phrase IS in context!")
else:
